...
przeznaczenia mających pomóc przy pisaniu oprogramowania 3D. Jest
oparty na OpenGL-u/Mesie oraz GNUstepie. Biblioteki zawierają
wszystko od klas geometrii wektorowej, takich jak macierze i wektory,
do pełnego API opisu sceny.
...
Pliki nagłówkowe bibliotek 3DKit.
